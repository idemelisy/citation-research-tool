...
- Generated: `2026-05-10T20:29:10.187693`
...
- #1 **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) — importance=5.078, relevance=0.839, graph_links=34
- #2 **Learning to summarize from human feedback** (`arxiv:2009.01325`) — importance=4.466, relevance=0.433, graph_links=36
- #3 **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) — importance=2.903, relevance=0.552, graph_links=18
- #4 **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) — importance=2.901, relevance=0.601, graph_links=17
- #5 **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) — importance=2.553, relevance=0.577, graph_links=14
- #6 **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) — importance=2.507, relevance=0.404, graph_links=17
- #7 **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) — importance=2.298, relevance=0.499, graph_links=13
- #8 **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) — importance=2.293, relevance=0.547, graph_links=12
- #9 **Scalable agent alignment via reward modeling: a research direction** (`openalex:W2901707424`) — importance=2.146, relevance=0.723, graph_links=7
- #10 **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) — importance=2.135, relevance=0.468, graph_links=12

## Topic separation

### General Preference Alignment

- **Learning to summarize from human feedback** (`arxiv:2009.01325`) (importance=4.466)
- **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) (importance=2.903)
- **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) (importance=2.901)
- **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) (importance=2.553)
- **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) (importance=2.507)
- **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) (importance=2.298)
- **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) (importance=2.293)
- **Scalable agent alignment via reward modeling: a research direction** (`openalex:W2901707424`) (importance=2.146)
- _... 47 more in this topic_

### Multimodal / Vision

- **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) (importance=2.135)
- **Evaluating Object Hallucination in Large Vision-Language Models** (`openalex:W4389523832`) (importance=1.835)
- **InstructBLIP: Towards General-purpose Vision-Language Models with Instruction Tuning** (`openalex:W4376312115`) (importance=1.447)
- **Qwen-VL: A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond** (`openalex:W4386185600`) (importance=1.052)
- **LLaVAR: Enhanced Visual Instruction Tuning for Text-Rich Image Understanding** (`openalex:W4382766522`) (importance=0.926)
- **The Instinctive Bias: Spurious Images lead to Illusion in MLLMs** (`openalex:W4404782342`) (importance=0.590)

### Core DPO Methods

- **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) (importance=5.078)
- **Direct Preference Optimization: Your Language Model is Secretly a Reward Model** (`openalex:W4378771755`) (importance=2.100)
- **Iterative Reasoning Preference Optimization** (`arxiv:2404.19733`) (importance=1.656)
- **ORPO: Monolithic Preference Optimization without Reference Model** (`arxiv:2403.07691`) (importance=1.566)

### Data Selection / Curation

- **Understanding the difficulty of training deep feedforward neural networks** (`openalex:W1533861849`) (importance=0.983)

### Reasoning / Stepwise

- **DetGPT: Detect What You Need via Reasoning** (`openalex:W4389519620`) (importance=1.804)
...
- Per-paper reference counts (top 15 by importance):
  ...
  - `openalex:W2901707424`: 120 references
  ...
  - `openalex:W2941610736`: 35 references
  - `openalex:W1544827683`: 19 references
