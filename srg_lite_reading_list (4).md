...
- Generated: `2026-05-10T20:03:54.810966`
- Query profile: intent=`method`, terms=direct, preference, optimization
...
- #1 **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) — importance=5.041, relevance=0.821, graph_links=34
- #2 **Learning to summarize from human feedback** (`arxiv:2009.01325`) — importance=4.743, relevance=0.571, graph_links=36
- #3 **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) — importance=2.453, relevance=0.326, graph_links=18
- #4 **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) — importance=2.348, relevance=0.324, graph_links=17
- #5 **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) — importance=2.271, relevance=0.286, graph_links=17
- #6 **Direct Preference Optimization: Your Language Model is Secretly a Reward Model** (`openalex:W4378771755`) — importance=2.100, relevance=1.000, graph_links=1
- #7 **RLHF-V: Towards Trustworthy MLLMs via Behavior Alignment from Fine-Grained Correctional Human Feedback** (`openalex:W4402727405`) — importance=1.966, relevance=0.383, graph_links=12
- #8 **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) — importance=1.900, relevance=0.250, graph_links=14
- #9 **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) — importance=1.771, relevance=0.285, graph_links=12
- #10 **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) — importance=1.756, relevance=0.278, graph_links=12

## Topic separation

### General Preference Alignment

- **Learning to summarize from human feedback** (`arxiv:2009.01325`) (importance=4.743)
- **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) (importance=2.453)
- **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) (importance=2.348)
- **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) (importance=2.271)
- **RLHF-V: Towards Trustworthy MLLMs via Behavior Alignment from Fine-Grained Correctional Human Feedback** (`openalex:W4402727405`) (importance=1.966)
- **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) (importance=1.900)
- **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) (importance=1.771)
- **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) (importance=1.703)
- _... 47 more in this topic_

### Multimodal / Vision

- **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) (importance=1.756)
- **Evaluating Object Hallucination in Large Vision-Language Models** (`openalex:W4389523832`) (importance=1.563)
- **InstructBLIP: Towards General-purpose Vision-Language Models with Instruction Tuning** (`openalex:W4376312115`) (importance=1.157)
- **The Instinctive Bias: Spurious Images lead to Illusion in MLLMs** (`openalex:W4404782342`) (importance=0.529)
- **Qwen-VL: A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond** (`openalex:W4386185600`) (importance=0.520)
- **LLaVAR: Enhanced Visual Instruction Tuning for Text-Rich Image Understanding** (`openalex:W4382766522`) (importance=0.502)

### Core DPO Methods

- **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) (importance=5.041)
- **Direct Preference Optimization: Your Language Model is Secretly a Reward Model** (`openalex:W4378771755`) (importance=2.100)
- **Iterative Reasoning Preference Optimization** (`arxiv:2404.19733`) (importance=1.359)
- **ORPO: Monolithic Preference Optimization without Reference Model** (`arxiv:2403.07691`) (importance=1.129)

### Data Selection / Curation

- **Understanding the difficulty of training deep feedforward neural networks** (`openalex:W1533861849`) (importance=0.418)

### Reasoning / Stepwise

- **DetGPT: Detect What You Need via Reasoning** (`openalex:W4389519620`) (importance=1.362)
...
- Per-paper reference counts (top 15 by importance):
  ...
  - `openalex:W4378771755`: 0 references
  ...
  - `openalex:W1522301498`: 20 references
...
- ★ **RLHF-V: Towards Trustworthy MLLMs via Behavior Alignment from Fine-Grained Correctional Human Feedback** — PII concept match ≈0.0, graph degree 12 (`openalex:W4402727405`)
- ★ **Woodpecker: Hallucination Correction for Multimodal Large Language Models** — PII concept match ≈0.0, graph degree 6 (`openalex:W4387947626`)
