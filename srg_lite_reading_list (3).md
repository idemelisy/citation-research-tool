...
- Generated: `2026-05-10T19:44:03.069021`
...
- #1 **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) — importance=5.395, relevance=0.998, graph_links=34
- #2 **Learning to summarize from human feedback** (`arxiv:2009.01325`) — importance=5.359, relevance=0.879, graph_links=36
...
- #4 **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) — importance=2.945, relevance=0.572, graph_links=18
- #5 **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) — importance=2.730, relevance=0.515, graph_links=17
- #6 **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) — importance=2.711, relevance=0.505, graph_links=17
- #7 **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) — importance=2.491, relevance=0.646, graph_links=12
- #8 **Evaluating Object Hallucination in Large Vision-Language Models** (`openalex:W4389523832`) — importance=2.361, relevance=0.730, graph_links=9
- #9 **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) — importance=2.327, relevance=0.463, graph_links=14
- #10 **ShareGPT4V: Improving Large Multi-modal Models with Better Captions** (`openalex:W4404575065`) — importance=2.292, relevance=0.746, graph_links=8

## Topic separation

### General Preference Alignment

- **Learning to summarize from human feedback** (`arxiv:2009.01325`) (importance=5.359)
...
- **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) (importance=2.945)
- **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) (importance=2.730)
- **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) (importance=2.711)
- **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) (importance=2.327)
- **ShareGPT4V: Improving Large Multi-modal Models with Better Captions** (`openalex:W4404575065`) (importance=2.292)
- **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) (importance=2.135)
- _... 47 more in this topic_

### Multimodal / Vision

- **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) (importance=2.491)
- **Evaluating Object Hallucination in Large Vision-Language Models** (`openalex:W4389523832`) (importance=2.361)
- **InstructBLIP: Towards General-purpose Vision-Language Models with Instruction Tuning** (`openalex:W4376312115`) (importance=1.762)
- **LLaVAR: Enhanced Visual Instruction Tuning for Text-Rich Image Understanding** (`openalex:W4382766522`) (importance=0.838)
- **Qwen-VL: A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond** (`openalex:W4386185600`) (importance=0.816)
- **The Instinctive Bias: Spurious Images lead to Illusion in MLLMs** (`openalex:W4404782342`) (importance=0.807)

### Core DPO Methods

- **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) (importance=5.395)
- **Direct Preference Optimization: Your Language Model is Secretly a Reward Model** (`openalex:W4378771755`) (importance=0.836)
- **Iterative Reasoning Preference Optimization** (`arxiv:2404.19733`) (importance=0.241)
- **ORPO: Monolithic Preference Optimization without Reference Model** (`arxiv:2403.07691`) (importance=0.241)

### Data Selection / Curation

- **Understanding the difficulty of training deep feedforward neural networks** (`openalex:W1533861849`) (importance=0.529)

### Reasoning / Stepwise

- **DetGPT: Detect What You Need via Reasoning** (`openalex:W4389519620`) (importance=1.861)
