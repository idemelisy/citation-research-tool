...
- Generated: `2026-05-10T20:16:31.073125`
...
- #1 **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) — importance=5.053, relevance=0.826, graph_links=34
- #2 **Learning to summarize from human feedback** (`arxiv:2009.01325`) — importance=4.397, relevance=0.399, graph_links=36
- #3 **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) — importance=3.111, relevance=0.705, graph_links=17
- #4 **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) — importance=3.069, relevance=0.635, graph_links=18
- #5 **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) — importance=2.769, relevance=0.685, graph_links=14
- #6 **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) — importance=2.713, relevance=0.507, graph_links=17
- #7 **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) — importance=2.450, relevance=0.575, graph_links=13
- #8 **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) — importance=2.441, relevance=0.621, graph_links=12
- #9 **Scalable agent alignment via reward modeling: a research direction** (`openalex:W2901707424`) — importance=2.322, relevance=0.811, graph_links=7
- #10 **ZeroGen: Efficient Zero-shot Learning via Dataset Generation** (`openalex:W4385573325`) — importance=2.263, relevance=0.632, graph_links=10

## Topic separation

### General Preference Alignment

- **Learning to summarize from human feedback** (`arxiv:2009.01325`) (importance=4.397)
- **An Actor-Critic Algorithm for Sequence Prediction** (`openalex:W2487501366`) (importance=3.111)
- **A Deep Reinforced Model for Abstractive Summarization** (`openalex:W2612675303`) (importance=3.069)
- **The Natural Language Decathlon: Multitask Learning as Question Answering** (`openalex:W2809324505`) (importance=2.769)
- **A bird's-eye view on coherence, and a worm's-eye view on cohesion.** (`openalex:W2899485151`) (importance=2.713)
- **Sequence Level Training with Recurrent Neural Networks** (`openalex:W2176263492`) (importance=2.450)
- **A Neural Attention Model for Abstractive Sentence Summarization** (`openalex:W1843891098`) (importance=2.441)
- **Scalable agent alignment via reward modeling: a research direction** (`openalex:W2901707424`) (importance=2.322)
- _... 47 more in this topic_

### Multimodal / Vision

- **Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding** (`openalex:W4402753774`) (importance=2.253)
- **Evaluating Object Hallucination in Large Vision-Language Models** (`openalex:W4389523832`) (importance=1.938)
- **InstructBLIP: Towards General-purpose Vision-Language Models with Instruction Tuning** (`openalex:W4376312115`) (importance=1.540)
- **Qwen-VL: A Versatile Vision-Language Model for Understanding, Localization, Text Reading, and Beyond** (`openalex:W4386185600`) (importance=1.129)
- **LLaVAR: Enhanced Visual Instruction Tuning for Text-Rich Image Understanding** (`openalex:W4382766522`) (importance=0.998)
- **The Instinctive Bias: Spurious Images lead to Illusion in MLLMs** (`openalex:W4404782342`) (importance=0.636)

### Core DPO Methods

- **Strengthening Multimodal Large Language Model with Bootstrapped Preference Optimization** (`openalex:W4403726885`) (importance=5.053)
- **Direct Preference Optimization: Your Language Model is Secretly a Reward Model** (`openalex:W4378771755`) (importance=2.100)
- **Iterative Reasoning Preference Optimization** (`arxiv:2404.19733`) (importance=1.620)
- **ORPO: Monolithic Preference Optimization without Reference Model** (`arxiv:2403.07691`) (importance=1.524)

### Data Selection / Curation

- **Understanding the difficulty of training deep feedforward neural networks** (`openalex:W1533861849`) (importance=1.059)

### Reasoning / Stepwise

- **DetGPT: Detect What You Need via Reasoning** (`openalex:W4389519620`) (importance=1.933)
...
- Per-paper reference counts (top 15 by importance):
  ...
  - `openalex:W2467173223`: 25 references
